...
export const X11_HELP_URL = 'https://github.com/electerm/electerm/wiki/Use-X11'
 ...
 */
export function getX11Candidates (display, platform = process.platform) {
 ...
 */
export function probeXServer (candidates, timeout = probeTimeout) {
 ...
 * @param {string} platform process.platform
 */
export function x11Hint (platform = process.platform) {
  if (platform === 'darwin') {
 ...
 * @param {string} platform process.platform
 */
export function x11CookieHint (platform = process.platform) {
