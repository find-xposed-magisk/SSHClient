/**
 * SSH Server widget
 * A local SSH server (backed by @electerm/ssh2) for quickly testing
 * SSH/SFTP connections against this machine.
 * ESM conversion of electerm's src/app/widgets/widget-ssh-server.js
 */
...
// @electerm/ssh2 is CommonJS: only `Client` is statically detectable by
// node's cjs-module-lexer, so grab `Server`/`utils` off the default export
